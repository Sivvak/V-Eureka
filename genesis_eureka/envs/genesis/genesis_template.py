...
# IMPORTANT: This import has to be included
...
# IMPORTANT: Name of the class should be Go2Env
class Go2Env:
    # IMPORTANT: The class should be initialized
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        self.reward_functions, self.episode_sums, self.reward_dicts = dict(), dict(), dict()
    ...
    # IMPORTANT: Define step function with given signature
    def step(self, actions):
        ...
        # IMPORTANT: Compute self.reward_buf as stated below. Include rew, rew_dict, self.episode_sums, self.extras['gpt_reward'] and self.reward_dicts
        self.rew_buf[:] = 0.0
    ...
    def reset_idx(self, envs_idx):
        ...
        # IMPORTANT: Log the rewards to self.extras["episode"]
        self.extras["episode"] = {}
